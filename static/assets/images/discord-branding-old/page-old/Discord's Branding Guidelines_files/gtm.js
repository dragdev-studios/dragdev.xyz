...
var Nd=[m.C,m.H],Od=function(a){var b=a[m.pe];b&&Ac(40);var c=a[m.qe];c&&Ac(41);for(var d=xa(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==m.pe&&f!==m.qe)if(-1<ya(Nd,f)){var h=f,k=a[f],l=d[e];yd().set(h,k,l,"GB","GB-ENG",c)}else{}},Pd=function(a,
